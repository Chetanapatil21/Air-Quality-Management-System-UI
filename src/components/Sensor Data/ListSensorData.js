        ...
        <div className="flex shadow border-b">
          <table className="min-w-full">
            <thead className="bg-gray-50">
              <tr>
                <THSensorData value="ID" location="left" border="r" />
                <THSensorData value="Sensor ID" location="left" border="r" />
                <THSensorData value="O2" location="left" border="r" />
                <THSensorData value="CO2" location="left" border="r" />
                <THSensorData value="SO2" location="left" border="r" />
                <THSensorData value="CO" location="left" border="r" />
                <THSensorData value="C" location="left" border="r" />
                <THSensorData value="Actions" location="right" border="r" />
              </tr>
            </thead>
