        ...
        <div className="flex shadow border-b">
          <table className="min-w-full">
            <thead className="bg-gray-50">
              <tr>
                <THSensorPlot value="ID" location="left" border="r" />
                <THSensorPlot value="Sensor ID" location="left" border="r" />
                <THSensorPlot value="Floor" location="left" border="r" />
                <THSensorPlot value="Room" location="left" border="r" />
                <THSensorPlot value="Actions" location="right" border="r" />
              </tr>
            </thead>
